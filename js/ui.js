    ...
    },
    {
      ...
      controls: [
        ...
        { key: 'eInvert', label: 'Invert depth', type: 'toggle', def: false, stage: 'depth',
          help: 'Use when the subject is lit dark-on-light. Says which side of the\n                 threshold is the subject.' },
        { key: 'eTolerance', label: 'Separation', min: 0, max: 1, step: 0.01, def: 0.18, stage: 'lines',
          help: 'How far the background is allowed to spread in from the frame. Raise it until the background is fully claimed; lower it before it starts eating the subject.' },
    ...
    },
    {
      ...
      controls: [
        ...
        { key: 'fInvert', label: 'Invert depth', type: 'toggle', def: false, stage: 'depth',
          help: 'Use when the subject is lit dark-on-light. Says which side of the\n                 threshold is the subject.' },
        { key: 'fTolerance', label: 'Separation', min: 0, max: 1, step: 0.01, def: 0.18, stage: 'lines',
          help: 'Where the ridges stop. Raise it until the background is fully claimed; lower it before it starts eating the subject.' },
